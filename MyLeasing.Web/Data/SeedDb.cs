...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("12345", "Mateo", "Zapata", "teoroldan015@gmail.com", "3225963030", "Calle Luna Calle Sol", "Manager");
            var owner = await CheckUserAsync("67890", "Mateo", "Roldan", "matie-17@hotmail.com", "3226598596", "Calle 45 #56-45", "Owner");
            var lessee = await CheckUserAsync("14785", "Mateo", "RZ", "mroldanz@sura.com.co", "3225605623", "Call 11 #65-34", "Lessee");
        ...
        private async Task CheckContractsAsync()
        {
            ...
            if (!_context.Contracts.Any())
            {
                _context.Contracts.Add(new Contract
                {
                    ...
                    "porttitor quis leo. In hac habitasse platea dictumst. Duis pharetra sed arcu ac viverra." +
                    " Proin dapibus lobortis commodo. Vivamus non commodo est, ac vehicula augue. Nam enim " +
                    "felis, rutrum in tortor sit amet, efficitur hendrerit augue. Cras pellentesque nisl " +
                    "eu maximus tempor. Curabitur eu efficitur metus. Sed ultricies urna et auctor commodo."
                });
